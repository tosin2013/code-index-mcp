...
from code_index_mcp.ingestion import chunk_file, ChunkStrategy
from code_index_mcp.embeddings import VertexAIEmbedder, EmbeddingConfig
...
def test_code_chunk_embeddings(use_mock=True):
    ...
    try:
        ...
        results = embedder.embed_code_chunks(
            test_chunks,
            use_metadata=True,
            show_progress=True
        )
