    ...
    def _traverse_node_single_pass(
            ...
            if name:
                ...
                for child in node.children:
                    self._traverse_node_single_pass(
                        child, context, current_class=name, current_method=current_method
                    )
                return
        ...
        # Handle method declarations
            ...
            if name:
                ...
                for child in node.children:
                    self._traverse_node_single_pass(
                        child, context, current_class=current_class, current_method=symbol_id
                    )
                return
        ...
        for child in node.children:
            self._traverse_node_single_pass(
                child, context, current_class=current_class, current_method=current_method
            )
