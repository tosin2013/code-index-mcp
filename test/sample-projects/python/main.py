...
from user_management import Person, User, UserManager
from user_management.models.user import UserRole
from user_management.services.auth_service import AuthService
from user_management.utils.exceptions import DuplicateUserError, UserNotFoundError
...
def main():
    ...
    try:
        ...
        user2 = user_manager.create_user(
            name="Charlie Brown", username="charlie", age=35, email="charlie@example.com"
        )
